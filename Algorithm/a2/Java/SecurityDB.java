public class SecurityDB extends SecurityDBBase {
    ...
    public static void main(String[] args) {
        ...
        db.addPassenger("Rob Bekker", "awd1238");
        db.addPassenger("Leong Hong-Man", "1111111");
        db.addPassenger("Wine Phoon", "11111111");
        db.addPassenger("UMAC MAC", "111111111");
        db.addPassenger("MUST MAC", "1111111111");
        db.addPassenger("MUST MAC", "11111111111");
        db.addPassenger("MUST MAC", "111111111111");
