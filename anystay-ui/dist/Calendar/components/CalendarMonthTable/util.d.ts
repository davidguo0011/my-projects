...
export declare function onMouseDown(rowIndex: number, columnIndex: number, selectionVisible: boolean, setSelectionVisible: Dispatch<SetStateAction<boolean>>, setSelection: Dispatch<SetStateAction<CalendarMonthTableSelection>>, selection: CalendarMonthTableSelection, tableCells: CalendarMonthTableCell[], firstSelection: React.MutableRefObject<CalendarMonthTableSelection>): void;
export declare function onTouchStart(rowIndex: number, columnIndex: number, selectionVisible: boolean, setSelectionVisible: Dispatch<SetStateAction<boolean>>, setSelection: Dispatch<SetStateAction<CalendarMonthTableSelection>>, selection: CalendarMonthTableSelection, tableCells: CalendarMonthTableCell[], firstSelection: React.MutableRefObject<CalendarMonthTableSelection>): void;
...
export declare function onSectionRenderJumpToToday(init: React.MutableRefObject<boolean>, todayScrollTop: React.MutableRefObject<number>, monthDate: CalendarMonthDate, setCustomScrollTop: Dispatch<SetStateAction<number>>, cellHeight: number): void;
