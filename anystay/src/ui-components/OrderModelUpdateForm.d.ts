...
export declare type OrderModelUpdateFormInputValues = {
    owner?: string;
...
export declare type OrderModelUpdateFormValidationValues = {
...
export declare type OrderModelUpdateFormOverridesProps = {
    OrderModelUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type OrderModelUpdateFormProps = React.PropsWithChildren<{
    overrides?: OrderModelUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    orderModel?: any;
    onSubmit?: (fields: OrderModelUpdateFormInputValues) => OrderModelUpdateFormInputValues;
    onSuccess?: (fields: OrderModelUpdateFormInputValues) => void;
    onError?: (fields: OrderModelUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: OrderModelUpdateFormInputValues) => OrderModelUpdateFormInputValues;
    onValidate?: OrderModelUpdateFormValidationValues;
} & React.CSSProperties>;
export default function OrderModelUpdateForm(props: OrderModelUpdateFormProps): React.ReactElement;
