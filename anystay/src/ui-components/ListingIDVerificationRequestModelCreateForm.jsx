...
import { createListingIDVerificationRequestModel } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function ListingIDVerificationRequestModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPrivateBucket(initialValues.privateBucket);
    setVerificationDocuments(initialValues.verificationDocuments);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createListingIDVerificationRequestModel.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(
        overrides,
        "ListingIDVerificationRequestModelCreateForm"
      )}
      {...rest}
    >
      <TextField
