...
export declare type BookingRequestModelUpdateFormInputValues = {
    owners?: string[];
    arrivalDate?: string;
...
export declare type BookingRequestModelUpdateFormValidationValues = {
...
export declare type BookingRequestModelUpdateFormOverridesProps = {
    BookingRequestModelUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type BookingRequestModelUpdateFormProps = React.PropsWithChildren<{
    overrides?: BookingRequestModelUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    bookingRequestModel?: any;
    onSubmit?: (fields: BookingRequestModelUpdateFormInputValues) => BookingRequestModelUpdateFormInputValues;
    onSuccess?: (fields: BookingRequestModelUpdateFormInputValues) => void;
    onError?: (fields: BookingRequestModelUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: BookingRequestModelUpdateFormInputValues) => BookingRequestModelUpdateFormInputValues;
    onValidate?: BookingRequestModelUpdateFormValidationValues;
} & React.CSSProperties>;
export default function BookingRequestModelUpdateForm(props: BookingRequestModelUpdateFormProps): React.ReactElement;
