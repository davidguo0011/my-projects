...
export default function UserModelCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCoverPicture(initialValues.coverPicture);
    setSavedListings(initialValues.savedListings);
    setCurrentSavedListingsValue("");
    setUsername(initialValues.username);
    setIdentityID(initialValues.identityID);
    setGuestMode(initialValues.guestMode);
    setStripeCustomerID(initialValues.stripeCustomerID);
    setPhoneConfirmed(initialValues.phoneConfirmed);
    setEmailConfirmed(initialValues.emailConfirmed);
    setUserIDConfirmed(initialValues.userIDConfirmed);
    setPrivacyPolicyAccepted(initialValues.privacyPolicyAccepted);
    setIdentityDocuments(initialValues.identityDocuments);
    ...
    setCleanlinessAverage(initialValues.cleanlinessAverage);
    setReferredBy(initialValues.referredBy);
    setReferralCode(initialValues.referralCode);
    setDeactivated(initialValues.deactivated);
    setSuspended(initialValues.suspended);
    setSuspendedUntil(initialValues.suspendedUntil);
    setSuspendedReason(initialValues.suspendedReason);
    setExternalSignOn(initialValues.externalSignOn);
    setExternalSignOnCompleted(initialValues.externalSignOnCompleted);
    setXiaozhuUserId(initialValues.xiaozhuUserId);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createUserModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
