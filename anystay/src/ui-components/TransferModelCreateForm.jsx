...
export default function TransferModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTransferAmount(initialValues.transferAmount);
    setTransferDate(initialValues.transferDate);
    setTransferInitiatedAt(initialValues.transferInitiatedAt);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TransferModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TransferModelCreateForm")}
      {...rest}
    >
      <TextField
