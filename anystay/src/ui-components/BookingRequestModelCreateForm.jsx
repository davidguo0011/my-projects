...
import { createBookingRequestModel } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function BookingRequestModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPaymentmodelID(initialValues.paymentmodelID);
    setStripeAccountID(initialValues.stripeAccountID);
    setConfirmationCode(initialValues.confirmationCode);
    setConversationmodelID(initialValues.conversationmodelID);
    ...
    setReasonDeclined(initialValues.reasonDeclined);
    setCancelled(initialValues.cancelled);
    setCancelledAt(initialValues.cancelledAt);
    setCancelledBy(initialValues.cancelledBy);
    setReasonCancelled(initialValues.reasonCancelled);
    setCompleted(initialValues.completed);
    setStayReviewed(initialValues.stayReviewed);
    setGuestReviewed(initialValues.guestReviewed);
    ...
    setBookingAmount(initialValues.bookingAmount);
    setBookingAmountIncludingServiceFee(
      initialValues.bookingAmountIncludingServiceFee
    );
    ...
    setPaymentModels(initialValues.paymentModels);
    setCurrentPaymentModelsValue("");
    setTransferModels(initialValues.transferModels);
    setCurrentTransferModelsValue("");
    setRefundModels(initialValues.refundModels);
    setCurrentRefundModelsValue("");
    setTransferReversalModels(initialValues.transferReversalModels);
    ...
    setHostPaid(initialValues.hostPaid);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createBookingRequestModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BookingRequestModelCreateForm")}
      {...rest}
    >
      <ArrayField
