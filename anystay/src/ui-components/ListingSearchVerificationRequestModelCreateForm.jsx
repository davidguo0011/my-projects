...
import { createListingSearchVerificationRequestModel } from "../graphql/mutations";
export default function ListingSearchVerificationRequestModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createListingSearchVerificationRequestModel.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(
        overrides,
        "ListingSearchVerificationRequestModelCreateForm"
      )}
      {...rest}
    >
      <TextField
