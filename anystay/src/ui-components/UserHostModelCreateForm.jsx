...
export default function UserHostModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setStripeAccountVerified(initialValues.stripeAccountVerified);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserHostModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserHostModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner"
