...
import { createOrderModel } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function OrderModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setProductmodelID(initialValues.productmodelID);
    ...
    setRefunded(initialValues.refunded);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createOrderModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OrderModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner"
