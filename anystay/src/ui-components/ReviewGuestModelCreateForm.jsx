...
import { createReviewGuestModel } from "../graphql/mutations";
export default function ReviewGuestModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setBookingRequestID(initialValues.bookingRequestID);
    setOverall(initialValues.overall);
    setCommunication(initialValues.communication);
    setCleanliness(initialValues.cleanliness);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createReviewGuestModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ReviewGuestModelCreateForm")}
      {...rest}
    >
      <TextField
