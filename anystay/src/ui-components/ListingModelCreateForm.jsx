...
import { createListingModel } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function ListingModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setReadOnlyOwners(initialValues.readOnlyOwners);
    ...
    setStateShort(initialValues.stateShort);
    ...
    setTypeOfPlace(initialValues.typeOfPlace);
    setPropertyDescription(initialValues.propertyDescription);
    setPropertyDescriptionEmbedding(initialValues.propertyDescriptionEmbedding);
    setCurrentPropertyDescriptionEmbeddingValue("");
    setPropertySoftEmbedding(initialValues.propertySoftEmbedding);
    setCurrentPropertySoftEmbeddingValue("");
    setTrainingEvolutions(initialValues.trainingEvolutions);
    setTranslatedPropertyDescription(
      initialValues.translatedPropertyDescription
    );
    setListingImages(initialValues.listingImages);
    ...
    setMinimumStay(initialValues.minimumStay);
    setMinimumPrice(initialValues.minimumPrice);
    setMaximumPrice(initialValues.maximumPrice);
    setNightlyPrices(initialValues.nightlyPrices);
    setCurrentNightlyPricesValue("");
    setMaximumStay(initialValues.maximumStay);
    setWeeklyMinimumPrice(initialValues.weeklyMinimumPrice);
    setWeeklyMaximumStay(initialValues.weeklyMaximumStay);
    setLocation(initialValues.location);
    setPropertyTitle(initialValues.propertyTitle);
    setInternalName(initialValues.internalName);
    setTranslatedPropertyTitle(initialValues.translatedPropertyTitle);
    setHouseRules(initialValues.houseRules);
    setCurrentHouseRulesValue("");
    setDraft(initialValues.draft);
    setVerified(initialValues.verified);
    setVerifiedDocuments(initialValues.verifiedDocuments);
    setCurrentVerifiedDocumentsValue("");
    setWeeklyDiscount(initialValues.weeklyDiscount);
    setMonthlyDiscount(initialValues.monthlyDiscount);
    setCleaningFee(initialValues.cleaningFee);
    setCleaningFrequency(initialValues.cleaningFrequency);
    setAvailabilityRange(initialValues.availabilityRange);
    setRooms(initialValues.rooms);
    setCurrentRoomsValue("");
    setTotalReviews(initialValues.totalReviews);
    setQualityScore(initialValues.qualityScore);
    setOverallAverage(initialValues.overallAverage);
    setCommunicationAverage(initialValues.communicationAverage);
    setAmenitiesAverage(initialValues.amenitiesAverage);
    setCleaningAverage(initialValues.cleaningAverage);
    setLocationAverage(initialValues.locationAverage);
    setServiceAverage(initialValues.serviceAverage);
    setValueAverage(initialValues.valueAverage);
    setCancellationPolicy(initialValues.cancellationPolicy);
    setOnceOffPaymentsOnly(initialValues.onceOffPaymentsOnly);
    setInstantBookEnabled(initialValues.instantBookEnabled);
    setStayType(initialValues.stayType);
    setAverageStayLength(initialValues.averageStayLength);
    setCurrentAverageStayLengthValue("");
    setCheckInTime(initialValues.checkInTime);
    setCheckOutTime(initialValues.checkOutTime);
    setCheckInInstructions(initialValues.checkInInstructions);
    setCheckOutInstructions(initialValues.checkOutInstructions);
    setTimeBeforeCheckIn(initialValues.timeBeforeCheckIn);
    setTimeAfterCheckOut(initialValues.timeAfterCheckOut);
    setExtraGuestFee(initialValues.extraGuestFee);
    setExtraMaxGuests(initialValues.extraMaxGuests);
    ...
    setICalUnavailableDates(initialValues.iCalUnavailableDates);
    setCurrentICalUnavailableDatesValue("");
    setICalImportLinks(initialValues.iCalImportLinks);
    setCurrentICalImportLinksValue("");
    setStraID(initialValues.straID);
    setAdvanceNotice(initialValues.advanceNotice);
    setAdvanceNoticeTime(initialValues.advanceNoticeTime);
    setApproved(initialValues.approved);
    setStandardServiceFee(initialValues.standardServiceFee);
    setFliggyApproved(initialValues.fliggyApproved);
    setFliggyHidden(initialValues.fliggyHidden);
    setFliggyID(initialValues.fliggyID);
    setWifiName(initialValues.wifiName);
    setWifiPassword(initialValues.wifiPassword);
    setPiggyApproved(initialValues.piggyApproved);
    setPiggyUpdatedAt(initialValues.piggyUpdatedAt);
    setAreaValue(initialValues.areaValue);
    setAreaUnit(initialValues.areaUnit);
    setXiaozhuRoomId(initialValues.xiaozhuRoomId);
    setXiaozhuReviewApproved(initialValues.xiaozhuReviewApproved);
    setXiaozhuAddressId(initialValues.xiaozhuAddressId);
    setXiaozhuRejectReasons(initialValues.xiaozhuRejectReasons);
    setCurrentXiaozhuRejectReasonsValue("");
    setCustomServiceFeePercent(initialValues.customServiceFeePercent);
    setHostawayListingId(initialValues.hostawayListingId);
    setHostawayLastSyncedAt(initialValues.hostawayLastSyncedAt);
    setHostawayReviewLastSyncedAt(initialValues.hostawayReviewLastSyncedAt);
    setHostawaySyncEnabled(initialValues.hostawaySyncEnabled);
    setGuestyListingId(initialValues.guestyListingId);
    setGuestyLastSyncedAt(initialValues.guestyLastSyncedAt);
    setGuestySyncEnabled(initialValues.guestySyncEnabled);
    setHomeheroListingId(initialValues.homeheroListingId);
    setCurrentHomeheroListingIdValue("");
    setHomeheroLastSyncedAt(initialValues.homeheroLastSyncedAt);
    setHomeheroSyncEnabled(initialValues.homeheroSyncEnabled);
    setHospitableListingId(initialValues.hospitableListingId);
    setHospitableLastSyncedAt(initialValues.hospitableLastSyncedAt);
    setHospitableSyncEnabled(initialValues.hospitableSyncEnabled);
    setHospitableSyncCompleted(initialValues.hospitableSyncCompleted);
    setInvitedUsers(initialValues.invitedUsers);
    setCurrentInvitedUsersValue("");
    setReadOnlyInvitedUsers(initialValues.readOnlyInvitedUsers);
    setCurrentReadOnlyInvitedUsersValue("");
    setSeoUpdatedAt(initialValues.seoUpdatedAt);
    setLodgifyPropertyId(initialValues.lodgifyPropertyId);
    setLodgifyRoomId(initialValues.lodgifyRoomId);
    setLodgifyLastSyncedAt(initialValues.lodgifyLastSyncedAt);
    setLodgifySyncEnabled(initialValues.lodgifySyncEnabled);
    setIsHotel(initialValues.isHotel);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createListingModel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ListingModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Created at"
