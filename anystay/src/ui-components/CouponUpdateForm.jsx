...
export default function CouponUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = couponRecord
      ...
      : initialValues;
    setExpireDate(cleanValues.expireDate);
    setBeginDate(cleanValues.beginDate);
    setDiscountAmount(cleanValues.discountAmount);
    setDiscountPercent(cleanValues.discountPercent);
    setMaxDiscountAmount(cleanValues.maxDiscountAmount);
    setMinAmount(cleanValues.minAmount);
    setCouponCode(cleanValues.couponCode);
    setTimesRedeemed(cleanValues.timesRedeemed);
    setValid(cleanValues.valid);
    setExclusive(cleanValues.exclusive);
    setValidUsers(cleanValues.validUsers ?? []);
    setCurrentValidUsersValue("");
    setInvalidUsers(cleanValues.invalidUsers ?? []);
    setCurrentInvalidUsersValue("");
    setOneTimeUse(cleanValues.oneTimeUse);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          couponCode,
          timesRedeemed: timesRedeemed ?? null,
          valid: valid ?? null,
          exclusive: exclusive ?? null,
          validUsers: validUsers ?? null,
          invalidUsers: invalidUsers ?? null,
