...
import { getListingUpdateSearchVerificationRequestModel } from "../graphql/queries";
import { updateListingUpdateSearchVerificationRequestModel } from "../graphql/mutations";
export default function ListingUpdateSearchVerificationRequestModelUpdateForm(
  props
) {
  const {
    id: idProp,
    listingUpdateSearchVerificationRequestModel:
      listingUpdateSearchVerificationRequestModelModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = listingUpdateSearchVerificationRequestModelRecord
      ? {
          ...initialValues,
          ...listingUpdateSearchVerificationRequestModelRecord,
        }
      : initialValues;
  ...
  const [
    listingUpdateSearchVerificationRequestModelRecord,
    setListingUpdateSearchVerificationRequestModelRecord,
  ] = React.useState(listingUpdateSearchVerificationRequestModelModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await API.graphql({
              query: getListingUpdateSearchVerificationRequestModel.replaceAll(
                "__typename",
                ""
              ),
              variables: { id: idProp },
            })
          )?.data?.getListingUpdateSearchVerificationRequestModel
        : listingUpdateSearchVerificationRequestModelModelProp;
      setListingUpdateSearchVerificationRequestModelRecord(record);
    };
    queryData();
  }, [idProp, listingUpdateSearchVerificationRequestModelModelProp]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: updateListingUpdateSearchVerificationRequestModel.replaceAll(
              "__typename",
              ""
            ),
            variables: {
              input: {
                id: listingUpdateSearchVerificationRequestModelRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(
        overrides,
        "ListingUpdateSearchVerificationRequestModelUpdateForm"
      )}
      {...rest}
    >
      <TextField
