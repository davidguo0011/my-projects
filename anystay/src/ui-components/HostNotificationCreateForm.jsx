...
import { createHostNotification } from "../graphql/mutations";
export default function HostNotificationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createHostNotification.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HostNotificationCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner"
