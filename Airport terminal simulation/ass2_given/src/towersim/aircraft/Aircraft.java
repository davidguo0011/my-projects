...
public abstract class Aircraft
        implements OccupancyLevel, Tickable, EmergencyState, Encodable {
    /**
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Aircraft)) {
            ...
            return this.getCallsign().equals(aircraft.getCallsign()) && this
                    .getCharacteristics().equals(aircraft.getCharacteristics());
        }
    }
    ...
    public String encode() {
        ...
        String fuel = df.format(this.getFuelAmount());
        return "" + this.getCallsign() + ":" + this.getCharacteristics() + ":"
                + this.getTaskList().encode() + ":" + fuel + ":" + this
                .hasEmergency();
    }
